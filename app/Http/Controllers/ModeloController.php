...
class ModeloController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($modelo === null) {
            ...
            'Modelo pesquisado não existe.'], 404);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($modelo === null) {
            return response()->json(['erro' => 'O modelo pesquisado para atualização não existe.'], 404);
        }
    ...
    public function destroy($id)
    {
        ...
        if ($modelo === null) {
            return response()->json(['erro' => 'O modelo pesquisado para ser deletado não existe.'], 404);
        }
